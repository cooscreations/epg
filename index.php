...
pagehead(); ?>
					...
					// echo $get_pages_SQL;
					  ...
					  while($row_get_pages = mysqli_fetch_array($result_get_pages)) {
							...
							$page_status 			= $row_get_pages['record_status'];
...
<div class="table-responsive">
  ...
  <tr>
    ...
    <td>
    	<a href="<?php echo $C_page_filename; ?>" type="button" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="fa fa-external-link"></i></a>
