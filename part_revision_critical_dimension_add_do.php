...
$crit_dim_measurement_type		= checkaddslashes($_REQUEST['crit_dim_dimension_type']);
...
if ($form_action == 'ADD') {
	...
	$add_SQL = "UPDATE `part_rev_critical_dimensions` SET 
	`ID`='" . $record_id . "',
	`part_revision_ID`='" . $part_rev_ID . "',
	`drawing_QC_ID`='" . $drawing_QC_ID . "',
	`dimension_type_ID`='" . $crit_dim_measurement_type . "',
	`dimension_minimum`='" . $crit_dim_dimension_minimum . "',
	`dimension_maximum`='" . $crit_dim_dimension_maximum . "',
	`specification_notes`='" . $crit_dim_specification_notes . "',
	`inspection_method_ID`='" . $inspection_method_ID . "',
	`inspection_level`='" . $crit_dim_inspection_level . "',
	`AQL_level`='" . $crit_dim_AQL_level . "',
	`record_status`='" . $record_status . "',
	`remarks`='" . $crit_dim_remarks . "' 
	WHERE `ID` = '" . $record_id . "'";

	$update_note = "Updating a Critical Dimension in the system.";
	$ACTION = 'UPDATE';
}
...
if (mysqli_query($con, $add_SQL)) {
    ...
    $record_edit_SQL = "INSERT INTO `update_log`(`ID`, `table_name`, `update_ID`, `user_ID`, `notes`, `update_date`, `update_type`, `update_action`) VALUES (NULL,'" . $table_name . "','" . $record_id . "','" . $_SESSION['user_ID'] . "','" . $update_note . "','" . date("Y-m-d H:i:s") . "', 'general', '" . $ACTION . "')";
