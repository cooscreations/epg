...
$add_movement_SQL = "INSERT INTO `part_batch_movement`(`ID`, `part_batch_ID`, `amount_in`, `amount_out`, `part_batch_status_ID`, `remarks`, `user_ID`, `date`) VALUES (NULL,'".$_REQUEST['batch_ID']."','" . $amount_in . "','" . $amount_out . "','" . $status_ID . "','" . $_REQUEST['remarks'] . "','" . $_REQUEST['created_by'] . "','" . $_REQUEST['date_added'] . " 00:00:00')";
