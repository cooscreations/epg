...
$add_movement_SQL = "INSERT INTO `part_batch_movement`(`ID`, `part_batch_ID`, `amount_in`, `amount_out`, `from_warehouse_ID`, `to_warehouse_ID`, `part_batch_status_ID`, `remarks`, `user_ID`, `date`, `record_status`) VALUES (NULL,'". $batch_ID ."','" . $amount_in . "','" . $amount_out . "','" . $from_warehouse_ID . "','" . $to_warehouse_ID . "','" . $status_ID . "','" . $remarks . "','" . $created_by . "','" . $date_added . "', '2')";
...
if (mysqli_query($con, $add_movement_SQL)) {
	...
	echo "<h4>Failed to update existing record with SQL: <br />" . $add_movement_SQL . "</h4>";
}
