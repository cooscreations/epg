    ...
    <div class="table-responsive">
        <table
            ...
            <td class="text-center">
					...
					$edit_URL 			= 'part_revision_critical_dimension_edit'; 	// REQUIRED - specify edit page URL
					$add_URL 			= 'part_revision_critical_dimension_add'; 		// REQURED - specify add page URL
