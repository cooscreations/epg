        ...
        <table class="table table-bordered table-striped table-condensed mb-none">
            ...
            <tr>
                ...
                <td class="text-center">
					...
					<a href="record_delete_do.php?table_name=suppliers&src_page=suppliers.php&id=<?php echo $row_get_sups['ID']; ?>" type="button" class="mb-xs mt-xs mr-xs btn btn-danger"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
