			...
			<div class="thumb-info mb-md" style="text-align:center;">
				...
				<div class="row">
				  <div class="text-center">
				    <a class="btn btn-danger" href="purchase_order_PDF.php?id=<?php echo $record_id; ?>" target="_blank" title="Make a PDF version of this purchase order in a new window">
