...
<section role="main" class="content-body">
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Add New Material</span></li>
			</ol>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<!-- START THE FORM! -->
			 <form class="form-horizontal form-bordered" action="material_add_do.php" method="post">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Add Material Details:</h2>
                    </header>
