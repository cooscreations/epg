									  ...
									  <thead>
										<tr>
									      ...
									      <?php 
									      	...
									      	$get_all_revs_SQL = "SELECT * FROM `part_revisions` WHERE `part_ID` = '" . $part_ID . "' AND `record_status` = '2'";
...
<!-- ************************************************************************************************************* -->
					...
					<!-- ********************************************************************* -->
					<!-- ********************************************************************* -->
					<!-- ************** START SELECT / DESELECT JS MAGIC! ******************** -->
					<!-- ********************************************************************* -->
					<!-- ********************************************************************* -->
					<!-- ********************************************************************* -->
						  <!-- auto-select other revs when 'ALL REVS' is selected: -->
						  <script>
							
							$("input.all_revs_<?php echo $this_mat_id; ?>").change(function() {
								if(this.checked) {
									//Do stuff
									$('input.rev_options_mat_ID_<?php echo $this_mat_id; ?>_rev_<?php echo $rev_ID_key; ?>').not(this).prop('checked', true);
								}
								else {
									// do other stuff!
									$('input.rev_options_mat_ID_<?php echo $this_mat_id; ?>_rev_<?php echo $rev_ID_key; ?>').not(this).prop('checked', false);
								}
							});
							
						  </script>
						  
						  <!-- now deselect 'ALL REVS' when a revision is deselected: -->
						  <script>
						  
							$('input.rev_options_mat_ID_<?php echo $this_mat_id; ?>_rev_<?php echo $rev_ID_key; ?>').on('change', function() {
								if(this.checked) {	
									$('input.all_revs_<?php echo $this_mat_id; ?>').not(this).prop('checked', false);
								}
								else {
									$('input.all_revs_<?php echo $this_mat_id; ?>').not(this).prop('checked', true);
								}  
							});
						  </script>
					<!-- ********************************************************************* -->
					...
					<!-- ********************************************************************* -->
							...
							<ul>
								...
								<li><input type="checkbox" class="group<?php echo $this_mat_id; ?>" name="check[]"> This is Item 1</li>
						...
						<td class="text-center">
							...
							<input type="checkbox" id="mat_<?php echo $this_mat_id; ?>_rev_<?php echo $rev_ID_key; ?>" class="group<?php echo $this_mat_id; ?>" name="check[]" />
						</td>
