...
<!-- START MAIN PAGE BODY : -->
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Edit Part Classification <?php if ($record_id != 0) { ?> <? echo $part_classification_name_EN . " / " . $part_classification_name_CN; } ?></h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								<li>
									...
									<li>
										<a href="part_classification.php">All Part Classification</a>
									</li>
								<li><span>Edit Part Classification Record</span></li>
							</ol>
